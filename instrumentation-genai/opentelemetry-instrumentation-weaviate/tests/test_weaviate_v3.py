...
class TestWeaviateV3SpanGeneration(WeaviateSpanTestBase):
    ...
    def test_schema_get_span(self):
        ...
        if schema_spans:
            ...
            self.assert_span_properties(schema_span, "db.weaviate.schema.get", SpanKind.CLIENT)
    ...
    def test_schema_create_class_span(self):
        ...
        with mock.patch('weaviate.connect.connection.Connection') as mock_connection:
            ...
            mock_response.text = ""
            client.schema._connection.post = mock.MagicMock(return_value=mock_response)
    ...
    def test_v3_error_handling_spans(self):
        ...
        with mock.patch('weaviate.connect.connection.Connection') as mock_connection:
            ...
            client.schema._connection.get = mock.MagicMock(return_value=mock_response)
